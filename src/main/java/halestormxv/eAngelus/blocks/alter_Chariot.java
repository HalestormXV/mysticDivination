 ...
 */
public class alter_Chariot extends Block
{
    private int chargeRequirment = eAngelusConfig.soulChargeReq;

    public alter_Chariot()
    {
        super(Material.IRON);
        this.setRegistryName("alter_chariot");
        this.setResistance(3F);
        this.setHardness(4F);
        this.setHarvestLevel("pickaxe", 3);
        this.setUnlocalizedName("alter_chariot");
        ...
        if (stack.getItem() == eAngelusItems.essence && stack.getMetadata() == 0)
        {
            ...
            if (nbt != null)
            {
                ...
                if (fetchKills >= chargeRequirment)
                {
                    ...
                    ItemStack chariotEssence = new ItemStack(eAngelusItems.essence, 1, 1);
                    playerIn.inventory.addItemStackToInventory(chariotEssence);
                }else{
            ...
            ChatUtil.sendNoSpam(playerIn,"\u00A73This alter will absorb the "+"\u00A74Soul Charges "+"\u00A73of an empty essence and convert it to an "+"\u00A76Essence of the Chariot.");
        }
        return false;
    }
}
